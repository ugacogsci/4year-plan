...
function build(st) {
  ...
  const input = { context, requirements: L.blocks, board, marks, pools, prior, interests, programName: L.program.name, programCollege: L.program.college, minimumTermCredits: 12, priorCredits, degreeTotal, trackPicks: tracked };
