...
function build(st) {
  ...
  const input = { context, requirements: L.blocks, board, marks, pools, prior, interests, career: st.career, programName: L.program.name, programCollege: L.program.college, minimumTermCredits: 12, priorCredits, degreeTotal, trackPicks: tracked, arrival: st.arrival };
