...
const CHIP_BOARDS = [
  ['generated board, last column open', wideCtx],
  ['generated board, first column open', earlyCtx],
  [`generated board, ${FOCUS.label} open`, ctx],
  ['generated board, nothing open', coldCtx],
  [`first ${SMALL.length} terms only`, smallCtx],
  ['empty board', emptyCtx],
];
...
console.log('');
process.exit(
  wrong === 0 && ruleFailures === 0 && emptinessLies === 0 && chipFailures === 0 && noteFailures === 0
    ? 0
    : 1,
);
